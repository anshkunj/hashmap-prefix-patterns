...
├── README.md                     # This file  
├── 560_subarray_sum_equals_k.py  # Subarray sum equals K  
├── 525_contiguous_array.py       # Prefix sum for 0/1 balance  
├── 974_subarray_sums_div_k.py    # Subarray sum divisible by K  
├── 217_contains_duplicate.py     # Frequency count using hashmap  
├── 454_4sum_ii.py                # Count quadruplets with hashmap  
